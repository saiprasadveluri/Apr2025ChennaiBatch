    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            // 1st Pickupride
            PickUpDrop pur1 = new PickUpDrop("Location 1", "Dest 1",
                DateTime.Now, DateTime.Now.AddMinutes(30),
                driver, customer, 10);

            rides[0] = pur1;//Assinging to array.
            // 2nd Pickupride
            rides[1] = new PrimePickUpDrop("Location 2", "Dest 2",
                DateTime.Now, DateTime.Now.AddMinutes(10),
                driver, customer, 5);

            // 3rd Rental
            rides[2] = new Rentals(5, 100, driver, customer, 45);

            // 4th Rental
            rides[3] = new Rentals(4, 120, driver, customer, 60);
