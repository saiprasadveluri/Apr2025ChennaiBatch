...
{
    internal class PickUpDrop : Ride, ICancellable, ICouponApplied // Derived class PickUpDrop is extends the Base Class Ride 
    {
        ...
        public PickUpDrop(string pickupLocation, string dropLocation,
