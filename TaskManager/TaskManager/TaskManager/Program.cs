...
namespace TaskManager
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            User siteAdmin = new User("admin@admin.com", "adminPass", "Site Admin");
            User projectManager = new User("pm@pm.com", "pmPass", "Project Manager");
            User developer = new User("dev@dev.com", "devPass", "Developer");
            User qa = new User("qa@qa.com", "qaPass", "QA");
