...
namespace TravelEzeeConsole
{
    internal class Program
    {
        ...
        static BookingModule bookingModule = new BookingModule();

        static void Main(string[] args)
        {
            bookingModule.ImportBookings();
            Console.WriteLine("Booking Details:");
            List<Booking> books = bookingModule.GetAllBookingDetails();
            foreach (Booking bd in books)
            {
