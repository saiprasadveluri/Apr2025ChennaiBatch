...
namespace TaskManager
{
    internal class TaskManager
    {
        static void Main(string[] args)
        {
            ...
            User manager = new User("Task Management Tool", "Project to manage tasks.", null, "Alice", "alice@example.com", "password123", "Project Manager");
            ...
            User manager1 = new User("Task2 manager", "Project to manage tasks.", null, "mary", "mary@example.com", "4357548", "Project Manager");
            User developer = new User("Task Management Tool", "Project to manage tasks.", manager, "Bobby", "bob@example.com", "985474", "Developer");
            User qa = new User("Task2 manager", "Project to manage tasks.", manager, "ram", "ram@example.com", "3542", "QA");
